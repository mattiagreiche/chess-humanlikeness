...
ax.set_xlabel('Opening Humanness', labelpad=8)
ax.set_ylabel('Middle Game Humanness', labelpad=8)
ax.set_zlabel('End Game Humanness', labelpad=8)

ax.set_title('Human-Likeness of Chess Grandmasters by Game Phase', fontsize=16)
...
plt.savefig('outputs/regression_means_plot.png', dpi=300, bbox_inches='tight', pad_inches=0.3)
